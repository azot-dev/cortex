...
Cortex comes with few gateways and adapters ready to use, so a project can be quick to start.
You can either extends from Cortex gateways and adapters or submit a pull request if your adding or modifications are generic enough